...
// Use official Femi9 product photography through the site's server-side image proxy.
export const products: Product[] = [
  {id:'330-double',slug:'femi9-330mm-double-wings',name:'Femi9 330mm Extra-Large 9 Pads — Double Wings',price:225,pack:'9 pads',length:'330mm',flow:'Heavy',usage:'Night + Day',description:'Extra-length protection with double wings for overnight security.',badge:'BESTSELLER',image:proxied(`${LIVE_PRODUCT}/1773300828_jFWVIMppz1.webp`),accent:'blush'},
  {id:'330-centre',slug:'femi9-330mm-centre-wings',name:'Femi9 330mm Extra-Large 9 Pads — Centre Wings',price:225,pack:'9 pads',length:'330mm',flow:'Heavy',usage:'Night',description:'Extra-length protection with centre wings and extended back coverage.',image:proxied(`${LIVE_PRODUCT}/1773300799_8RwUly1byg.webp`),accent:'sand'},
  {id:'290-large',slug:'femi9-290mm-large',name:'Femi9 290mm Large 9 Pads',price:198,pack:'9 pads',length:'290mm',flow:'Regular',usage:'Everyday',description:'The everyday large with breathable cotton comfort for your cycle.',image:proxied(`${LIVE_PRODUCT}/1773127765_EA2vx1qoIA.webp`),accent:'cream'},
  {id:'290-starter',slug:'femi9-290mm-starter',name:'Femi9 290mm Large 3 Pads',price:72,pack:'3 pads',length:'290mm',flow:'Regular',usage:'Everyday',description:'A three-pad starter pack to experience Femi9.',badge:'TRIAL PACK',image:proxied(`${LIVE_PRODUCT}/1773132065_WZLOmMA0v1.webp`),accent:'rose'},
  {id:'330-six',slug:'femi9-330mm-6-pads',name:'Femi9 330mm Extra-Large 6 Pads',price:162,pack:'6 pads',length:'330mm',flow:'Heavy',usage:'Night + Day',description:'Extra-large 330mm protection in a six-pad pack.',image:proxied(`${LIVE_PRODUCT}/1773134388_YEdjy67KqS.webp`),accent:'blush'},
  {id:'330-three',slug:'femi9-330mm-3-pads',name:'Femi9 330mm Extra-Large 3 Pads',price:81,pack:'3 pads',length:'330mm',flow:'Heavy',usage:'Night + Day',description:'A compact three-pad pack for trying the 330mm XL range.',image:proxied(`${LIVE_PRODUCT}/1773133877_isSPEIYue4.webp`),accent:'sand'},
  {id:'290-six',slug:'femi9-290mm-6-pads',name:'Femi9 290mm Large 6 Pads',price:141,pack:'6 pads',length:'290mm',flow:'Regular',usage:'Everyday',description:'Six everyday 290mm pads for regular-flow days.',image:proxied(`${LIVE_PRODUCT}/1773132065_WZLOmMA0v1.webp`),accent:'cream'},
  {id:'180-mini',slug:'femi9-180mm-mini-pads',name:'Femi9 180mm Pads — Everyday Essentials',price:234,pack:'30 pads',length:'180mm',flow:'Light flow',usage:'Daily freshness',description:'Ultra-thin everyday protection for light flow, spotting and daily discharge.',image:proxied(`${LIVE_PRODUCT}/1744820580_NwCzXwxGOs.webp`),accent:'mist'},
];
