...
// Product photography below is taken from the existing Femi9 website/product catalogue,
// rather than generated or placeholder imagery.
export const products: Product[] = [
  ...
  {id:'330-centre',slug:'femi9-330mm-centre-wings',name:'Femi9 330mm Extra-Large 9 Pads — Centre Wings',price:225,pack:'9 pads',length:'330mm',flow:'Heavy',usage:'Night',description:'Extra-length protection with centre wings and extended back coverage.',image:`${ASSET}/prod-330-centre.webp`,accent:'sand'},
  ...
  {id:'290-starter',slug:'femi9-290mm-starter',name:'Femi9 290mm Large 3 Pads',price:72,pack:'3 pads',length:'290mm',flow:'Regular',usage:'Everyday',description:'A three-pad starter pack to experience Femi9.',badge:'TRIAL PACK',image:`${ASSET}/prod-290-large3.webp`,accent:'rose'},
  ...
  {id:'330-three',slug:'femi9-330mm-3-pads',name:'Femi9 330mm Extra-Large 3 Pads',price:81,pack:'3 pads',length:'330mm',flow:'Heavy',usage:'Night + Day',description:'A compact three-pad pack for trying the 330mm XL range.',image:`${LIVE_PRODUCT}/1773133252_Z8x7rRTQcf.webp`,accent:'sand'},
